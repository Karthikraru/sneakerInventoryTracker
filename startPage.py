...
class startPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.analysis = tk.PhotoImage(file='images/dataAnalysis.png')
        ...
        analysisButton = tk.Button(self, image=self.analysis, bg=background, command=lambda: controller.showFrame("analysis"))
        ...
        analysisButton.grid(row=2, column=1, pady=10, padx=10)